...
public class B18ArrayTest {
    ...
    public static void main(String[] args) {
        ...
        // 자바크스립트는 배열 메소드 중에 push(), pull() 로 배열의 크기(length)가 동적으로 변경
        // 자바는 배열 크기는 고정된 크기 입니다.
        // 자바 배열 관련 메소드는 Arrays 클래스의 static 메소드를 사용합니다.
