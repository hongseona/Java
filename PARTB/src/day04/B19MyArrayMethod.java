...
public class B19MyArrayMethod {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("sumOfSrrayValue - scores 배열: " + sumOfArrayValue(scores));
        System.out.println("sumOfSrrayValue - scores2 배열: " + sumOfArrayValue(scores2));
    ...
    // Arrays.copyOf 는 배열을 1개만 지정하고 target 배열 지정을 못해요(=> 사용불가)
    ...
    // arr2 를 target 배열 result 에 복사
    // 첫번째 반복문이 끝나면 result 인덱스 변수 i = arr1.length 부터 시작하기
