...
public class D03ArrayList {
    public static void main(String[] args) {
        ...
        // 리스트의 크기(가변적:데이터가 추가,삭제되는가에 따라서 변동)
        // 리스트도 배열처럼 인덱스를 가짐
        int size = list.size();
        ...
        System.out.println("삭제 후 list 크기: "+list);
        ...
        System.out.println("\tlist,lastIndex:" + list.lastIndexOf("mellon"));
        System.out.println("\tlist,lastIndex:" + list.lastIndexOf("mellon"));
        // 없는 요소 찾으면 -1 리턴

        System.out.println("특정 데이터의 저장 여부: contains");
        System.out.println("\tmango 있음?");
        System.out.println("\tblueberry 있음?");
