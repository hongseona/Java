...
public class D01BitOperatorTest {
    public static void main(String[] args) {
        ...
        // 타입이 정수면 "%s"의 s앞에 0을 붙여주면 공백에 0을 표기해주지만, 위 코드는 String  이기떄문에 replace를 사용하여 표기
        ...
        // 2진수의 자리값은 ....    ㄴ4096 2048 1024 512        256 128 64 32 16 8 4 2 1 
