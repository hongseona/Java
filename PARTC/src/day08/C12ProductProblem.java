...
public class C12ProductProblem {
    public static void main(String[] args) {
        ...
        Double a = 123.45;      // 래퍼 클래스, 즉 객체 타입
        Double b = 234.56;
        // 래퍼클래스 : 기본 자료형을 객체로 감싸는 클래스
        // 기본형은 null 값을 가질수 없는데 null값을 주고 싶을떄 래퍼 클래스 활용
        // 기본형=> double a= 123.45;  래퍼클래스=> Double a=123.45;
...
class Product implements Comparable<Product>, Cloneable{
    ...
    public int compareTo(Product other) {
        ...
        // 1안) 42456.34 - 42456.12와 42456.12 - 42456.34를 강제로 int 변환하면  값이 0.
        //    => 2개가 같은 값으로 처리됨. 소수점 이하 자리 비교와 정확한 정렬을 못함
        // return Double.compare(this.price, other.price); // 2안
        // return this.price.compare(other.price);      // 3안
